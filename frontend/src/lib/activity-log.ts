...
export const ACTIVITY_ACTION_LABELS: Record<string, string> = {
  ...
  "auth.login.unverified": "Connexion refusée (e-mail non vérifié)",
  "auth.login.otp_sent": "Code de connexion envoyé",
  "auth.login.otp_failed": "Code de connexion incorrect",
  "auth.login.otp_resend": "Code de connexion renvoyé",
  "auth.email.verify": "E-mail vérifié",
  "auth.email.verify.resend": "E-mail de vérification renvoyé",
  "auth.profile.update": "Profil modifié",
